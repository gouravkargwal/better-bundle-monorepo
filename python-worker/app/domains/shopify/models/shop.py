...
class ShopifyShop(BaseModel):
    ...
    access_token: Optional[str] = Field(None, description="Shop access token")
    ...
    google_analytics_account: Optional[str] = Field(
        None, description="Google Analytics account"
    )
    google_analytics_domain: Optional[str] = Field(
        None, description="Google Analytics domain"
    )
    ...
    created_at: datetime = Field(
        default_factory=now_utc, description="Shop creation date"
    )
    ...
    bb_installed_at: Optional[datetime] = Field(
        None, description="When BetterBundle was installed"
    )
