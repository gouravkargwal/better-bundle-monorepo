...
class ShopifyOrder(BaseModel):
    ...
    name: str = Field(..., description="Order name/number")
    ...
    # Timestamps
    created_at: datetime = Field(default_factory=now_utc, description="Order creation date")
    updated_at: datetime = Field(default_factory=now_utc, description="Last update date")
    ...
    # Line items
    line_items: List[ShopifyOrderLineItem] = Field(default_factory=list, description="Order line items")
