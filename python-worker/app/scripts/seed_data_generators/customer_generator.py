...
class CustomerGenerator(BaseGenerator):
    ...
    def generate_customers(self) -> List[Dict[str, Any]]:
        """Generate 25 diverse customer profiles for better ML training."""
        customer_profiles = [
            {
                "name": "Alice Johnson",
            ...
            # Additional diverse customer profiles for better ML training
            {
                "name": "Ivy Chen",
                "email": "ivy.chen@email.com",
                "profile_type": "fashion_enthusiast",
                "total_spent": 320.00,
                "orders_count": 5,
                "tags": ["fashion", "trendy", "social-media"],
                "created_days_ago": 45,
                "last_order_days_ago": 1,
                "preferred_categories": ["Clothing", "Accessories"],
                "avg_order_value": 64.00,
            },
            {
                ...
                "profile_type": "tech_early_adopter",
                "total_spent": 890.00,
                "orders_count": 6,
                "tags": ["tech", "early-adopter", "high-value"],
                "created_days_ago": 90,
                "last_order_days_ago": 4,
                "preferred_categories": ["Electronics", "Gadgets"],
                "avg_order_value": 148.33,
            },
            {
                "name": "Kelly Rodriguez",
                "email": "kelly.rodriguez@email.com",
                "profile_type": "bargain_hunter",
                "total_spent": 95.00,
                "orders_count": 4,
                "tags": ["bargain", "discount-seeker", "price-conscious"],
                "created_days_ago": 30,
                "last_order_days_ago": 6,
                "preferred_categories": ["Accessories", "Home"],
                "avg_order_value": 23.75,
            },
            {
                "name": "Liam O'Connor",
                "email": "liam.oconnor@email.com",
                "profile_type": "seasonal_buyer",
                "total_spent": 180.00,
                "orders_count": 2,
                "tags": ["seasonal", "holiday-shopper"],
                "created_days_ago": 15,
                "last_order_days_ago": 8,
                "preferred_categories": ["Clothing", "Home"],
                "avg_order_value": 90.00,
            },
            {
                "name": "Maya Patel",
                "email": "maya.patel@email.com",
                "profile_type": "family_shopper",
                "total_spent": 420.00,
                "orders_count": 7,
                "tags": ["family", "bulk-buyer", "repeat-customer"],
                "created_days_ago": 75,
                "last_order_days_ago": 2,
                "preferred_categories": ["Clothing", "Home", "Accessories"],
                "avg_order_value": 60.00,
            },
            {
                "name": "Noah Kim",
                "email": "noah.kim@email.com",
                "profile_type": "mobile_shopper",
                "total_spent": 150.00,
                "orders_count": 3,
                "tags": ["mobile", "app-user", "quick-checkout"],
                "created_days_ago": 20,
                "last_order_days_ago": 5,
                "preferred_categories": ["Electronics", "Accessories"],
            ...
            },
            {
                ...
                "profile_type": "international_customer",
                "total_spent": 280.00,
                "orders_count": 4,
                "tags": ["international", "shipping-aware"],
                "created_days_ago": 40,
                "last_order_days_ago": 7,
                "preferred_categories": ["Clothing", "Electronics"],
                "avg_order_value": 70.00,
            },
            {
                ...
                "profile_type": "sustainable_shopper",
                "total_spent": 200.00,
                "orders_count": 3,
                "tags": ["eco-friendly", "sustainable", "conscious"],
                "created_days_ago": 25,
                "last_order_days_ago": 9,
                "preferred_categories": ["Clothing", "Home"],
                "avg_order_value": 66.67,
            },
            {
                "name": "Ruby Singh",
                "email": "ruby.singh@email.com",
                "profile_type": "gift_buyer",
                "total_spent": 160.00,
                "orders_count": 4,
                "tags": ["gift-buyer", "special-occasions"],
                "created_days_ago": 35,
                "last_order_days_ago": 3,
