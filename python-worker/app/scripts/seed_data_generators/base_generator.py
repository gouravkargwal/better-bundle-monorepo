...
class BaseGenerator:
    ...
    def _generate_dynamic_ids(self) -> Dict[str, str]:
        ...
        # Products (15 total for more variety)
        for i in range(1, 16):
