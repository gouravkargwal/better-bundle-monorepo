...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  try {
    ...
    // Store raw order cancellation data immediately
    ...
    console.log(
      `✅ Order ${orderId} cancellation stored in raw table for shop ${shop}`,
    );
    ...
    return json({
      ...
      orderId: orderId,
      shopId: shopRecord.id,
      message: "Order cancellation data stored successfully",
    });
  } catch (error) {
